...
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.0.txt')
data0 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.1.txt')
data1 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.2.txt')
data2 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.3.txt')
data3 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.4.txt')
data4 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.5.txt')
data5 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.6.txt')
data6 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.7.txt')
data7 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.8.txt')
data8 = np.array(df, dtype='float32')
df = pd.read_csv('~/Dropbox/Courses/Data Analysis/Handwriting/train.9.txt')
